...
class Exit_Frame(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        self.button_EXIT_CANCEL = wx.Button(id=wxID_EXIT_FRAME_EXIT_CANCEL,
...
class MainFrame(wx.Frame):
    def __init__(self, parent, ID, title, prec_args):
        ...
        self.bitmap_button_PlayBack = wx.BitmapButton(self.control_panel, -1, wx.Bitmap("E:\\workspace\\KacRing\\kak-ring-animation\\trunk\\pngs\\control_rewind.png", wx.BITMAP_TYPE_ANY))
        self.panel_dummy_2 = wx.Panel(self.control_panel, -1)

        self.bitmap_button_FrameBack = wx.BitmapButton(self.control_panel, -1, wx.Bitmap("E:\\workspace\\KacRing\\kak-ring-animation\\trunk\\pngs\\control_back.png", wx.BITMAP_TYPE_ANY))
        self.panel_dummy_3 = wx.Panel(self.control_panel, -1)

        self.bitmap_button_Stop = wx.BitmapButton(self.control_panel, -1, wx.Bitmap("E:\\workspace\\KacRing\\kak-ring-animation\\trunk\\pngs\\control_stop.png", wx.BITMAP_TYPE_ANY))
        self.panel_dummy_4 = wx.Panel(self.control_panel, -1)

        self.bitmap_button_FrameNext = wx.BitmapButton(self.control_panel, -1, wx.Bitmap("E:\\workspace\\KacRing\\kak-ring-animation\\trunk\\pngs\\control_play.png", wx.BITMAP_TYPE_ANY))
        self.panel_dummy_5 = wx.Panel(self.control_panel, -1)

        self.bitmap_button_PlayNext = wx.BitmapButton(self.control_panel, -1, wx.Bitmap("E:\\workspace\\KacRing\\kak-ring-animation\\trunk\\pngs\\control_fastforward.", wx.BITMAP_TYPE_ANY))
