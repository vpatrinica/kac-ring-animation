...
%Publication list for Art and Literature
\newpage
...
Amodeo, I. (2006). "comme dans l'atmosph\‘{e}re d'un autre monde". Die Oper in der Literatur als Traum und als Wirklichkeit. Ausgew\"{a}hlte Beispiele. In P. Csobádi, G. Gruber, J. K\"{u}hnel, U. M\"{u}ller, O. Panagl, \& F.V. Spechtler (Eds.), \textit{Traum und Wirklichkeit in Theater und Musiktheater. Vortr\"{a}ge und Gespr\"{a}che des Salzburger Symposions 2004} (pp. 49-57). Salzburg: Mueller-Speiser.\\
...
Amodeo, I. (2006), La letteratura della migrazione in Germania. In A. Gnisci (Ed.), \textit{Nuovo Planetario italiano. Guida alla letteratura italiana della migrazione} (pp. 1-8). Rome: Città aperta edizioni.\\

Amodeo, I. (2006). Le spectacle du corps. Images corporelles du XVIIe si\‘{e}cle au cin\’{e}ma. In E. Erdmann, \& K. Schoell (Eds.), Le comique corporel. Mouvement et comique dans l'espace th\’{e}âtral du XVIIe si\‘{e}cle (pp. 149-160). T\"{u}bingen: Gunter Narr Verlag.\\
...
Crowther, P. (2006). Po Heideggerju: Kraj sculpture. In \textit{Filozofski vestnik}, Vol. XXVII, No3, pp. 45-66.\\
...
Knorpp, E. (2006). Rezension des Ausstellungskatalogs Gerhard Kolberg [Hg.]: \textit{Salvador Dalí. La Gare de Perpignan Pop, Op, Yes-yes, Pompier,} Ostfildern: Hatje Cantz, 2006 [www.portalkunstgeschichte.de, last accessed: June 26, 2006].\\
